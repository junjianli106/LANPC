...
def main(cfg):
    ...
    setproctitle.setproctitle(cfg.config + "   " + 'fold' + str(cfg.Data.fold))
...
if __name__ == '__main__':
    ...
    #cfg.General.log_path = os.path.join(home_path, cfg.General.log_path[1:])
    #cfg.Data.data_dir = os.path.join(home_path, cfg.Data.data_dir[1:])

    #print(home_path)
    #print(os.path.join(home_path, cfg.General.log_path))
